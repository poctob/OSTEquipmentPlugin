...
$(function() {
    ...
    $.widget("xpresstek.etree", {
        ...
        _renderNode: function(node, container) {
            ...
            inlineStyle = node.color?'style="color:' + node.color+';"' : '',
            image = node.image?'<img src="equipment_front/'+ node.image+'" class="etreeImage"/>' : '',
            ...
            contentElement.append('<span class="' + toggleIcon + '"></span>')
                            ...
                            .append(image)
                            .append('<span class="pui-treenode-label ui-corner-all" '+ inlineStyle+'>' + node.label + '</span>')
