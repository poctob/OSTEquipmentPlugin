...
$sortOptions=array('name'=>'cat.name','type'=>'cat.ispublic','equipments'=>'equipments','updated'=>'cat.updated');
...
$total=db_count('SELECT count(*) FROM '.EQUIPMENT_CATEGORY_TABLE.' cat ');
$page=($_GET['p'] && is_numeric($_GET['p']))?$_GET['p']:1;
$pageNav=new Pagenate($total, $page, PAGE_LIMIT);
$pageNav->setURL('equipment_categories.php',$qstr.'&sort='.urlencode($_REQUEST['sort']).'&order='.urlencode($_REQUEST['order']));
...
if($res && ($num=db_num_rows($res)))
    ...
    $showing='No Equipment categories found!';
...
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
    <b><a href="equipment_categories.php?a=add" class="Icon newCategory">Add New Category</a></b></div>
<div class="clear"></div>
<form action="equipment_categories.php" method="POST" name="cat">
 <?php csrf_token(); ?>
    ...
    <tfoot>
     <tr>
        <td colspan="5">
            ...
            <?php }else{
                echo 'No Equipment categories found.';
            } ?>
        </td>
     </tr>
    </tfoot>
